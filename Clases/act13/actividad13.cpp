...
//Mostrando los libros ingresados
	...
	do {
		...
		case 5: cout << "Buscando..." << endl;
			if (buscarEspa())
				...
				cout << "Solo hay libros de distintos idiomas" << endl;
		case 6: cout << "Buscando..." << endl;
			if (buscarC())
				cout << "Si hay libros de ciencia ficcion disponible" << endl;
			else
				cout << "No hay libros de ese genero" << endl;
